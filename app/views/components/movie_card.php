<?php
// app/views/components/movie_card.php
// Expected variable: $movie_data (an array with movie info from OMDB)

if (!isset($movie_data) || empty($movie_data)) {
    return; // Do nothing if no movie data
}
?>
...
<div class="col">
    <div class="card h-100 shadow-sm">
        <img src="<?php echo htmlspecialchars($movie_data['Poster'] !== 'N/A' ? $movie_data['Poster'] : 'https://via.placeholder.com/200x300?text=No+Poster'); ?>"
             class="card-img-top mx-auto mt-2" alt="<?php echo htmlspecialchars($movie_data['Title']); ?> Poster"
