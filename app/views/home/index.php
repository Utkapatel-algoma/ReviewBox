    ...
    <body>
        <?php include '../components/header.php'; // Updated header include path ?>
                ...
                <div class="col-md-8">
                    <form action="/movie/search" method="GET" class="mb-4">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search for a movie..." name="q"
                                   value="<?php echo htmlspecialchars($searchTerm); ?>" aria-label="Search for a movie">
